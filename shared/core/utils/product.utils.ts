...
import { CreateProductWithVariantsRequest, UpdateProductImagesRequest } from "@shared/features/product/product.types";
...
export const buildFormDataForCreateProduct = (
    ...
    if (formValues.variantsPayload) {
        const variantsWithKeys = assignFileKeysToVariants(formValues.variantsPayload);
...
export const buildFormDataForUpdateImages = (
    ...
    if (payload.keepImages) formData.append("keepImages", JSON.stringify(payload.keepImages));
