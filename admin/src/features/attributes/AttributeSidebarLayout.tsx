...
export const AttributeSidebarLayout: React.FC<AttributeSidebarLayoutProps> = ({
	...
	const [selectedValueByAttribute, setSelectedValueByAttribute] = useState<
	...
	const toggleSingleSelect = (attributeId: string, value: AttributeValue) => {
		setSelectedValueByAttribute((prev) => {
			...
			console.log(
				`Attribute ${attributeId} selected value:`,
				newSelected[attributeId]
			);
			return newSelected;
		});
	};
		...
		return (
			<div className="space-y-6">
				...
				<AttributeHeader
					...
					onUpdated={reloadAdminAttributes}
