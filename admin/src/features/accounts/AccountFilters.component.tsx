        ...
        <div className="flex flex-col gap-4 p-6 bg-white rounded-3xl shadow-2xl">
            ...
            {/* <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full">
                ...
                {[
                    ...
                    className={clsx(
                        "flex items-center gap-2 px-4 py-2 rounded-full font-medium transition-all duration-200 shadow-sm hover:shadow-lg transform hover:-translate-y-0.5 text-sm",
                ...
                <div className="flex flex-wrap items-center gap-2 p-3 bg-gray-50 rounded-2xl shadow-inner border border-gray-200 flex-1">
                    ...
                    {[
                        { label: "Tất cả", value: null, color: "from-gray-400 via-gray-350 to-gray-600", icon: <Grid size={18} /> },
                        { label: "Chưa chặn", value: false, color: "from-green-400 via-green-500 to-green-600", icon: <Unlock size={18} /> },
                        { label: "Đã chặn", value: true, color: "from-red-400 via-red-500 to-red-600", icon: <Lock size={18} /> },
                    ].map((item) => (
                        <button
                        key={item.label}
                        onClick={() => setShowBanned(item.value)}
                        className={clsx(
                            "flex items-center gap-2 px-4 py-2 rounded-full font-medium text-sm transition-all duration-200 shadow-sm hover:shadow-lg transform hover:-translate-y-0.5",
