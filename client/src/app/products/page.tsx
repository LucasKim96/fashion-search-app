...
// 					{" "}
// 					{/* Căn giữa nhìn sẽ quyền lực hơn */}
// 					<h1 className="text-4xl font-extrabold tracking-tight text-primary-dark uppercase">
// 						Tất cả sản phẩm
// 					</h1>
// 					<p className="mt-2 text-lg text-text-muted">
// 						Khám phá bộ sưu tập thời trang mới nhất của chúng tôi.
// 					</p>
// 					{/* Icon trang trí nhỏ ở dưới */}
// 					<div className="mx-auto w-12 h-1 bg-secondary mt-4 rounded-full opacity-50"></div>
// 				</div>
