...
import {
	...
	GradientButton,
	Table,
	buildFormDataForAttributeValues,
} from "@shared/core";
import {
	Plus,
	Trash2,
		...
		<div className="space-y-6 pb-20">
			...
			<div className="flex justify-between items-center">
				<h2 className="flex items-center gap-2 text-2xl font-semibold uppercase text-indigo-600 tracking-wide drop-shadow-sm relative">
					Tạo thuộc tính
					<Edit2 className="ml-2 w-6 h-6 text-indigo-500" />
			...
			<div className="flex flex-wrap items-end gap-4">
				...
				{/* --- PHẦN NOTE MỚI THÊM --- */}
				<div className="mb-1 flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-50 border border-indigo-100 text-indigo-700 shadow-sm animate-in fade-in slide-in-from-left-4">
					<Info className="w-4 h-4 flex-shrink-0" />
					<span className="text-sm font-medium">
						<span className="font-bold">Lưu ý:</span> Hình ảnh minh họa cho giá
						trị là tùy chọn (không bắt buộc).
					</span>
				</div>
			</div>
