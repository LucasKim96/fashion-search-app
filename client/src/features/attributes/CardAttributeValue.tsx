...
import { AttributeValue, useAttributeValue, UpdateAttributeValueRequest, Attribute } from "@shared/features/attribute";
...
export const CardAttributeValue: React.FC<CardAttributeValueProps> = ({
    ...
    const { updateShopAttributeValue, toggleShopAttributeValue, deleteShopAttributeValue } = useAttributeValue();
