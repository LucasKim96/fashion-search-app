...
export const createAttributeValueAdmin = (req, res) =>
	handleCreateAttributeValue(req, res, true);

export const updateAttributeValueAdmin = (req, res) =>
	handleUpdateAttributeValue(req, res, { isAdmin: true });

export const toggleAttributeValueAdmin = (req, res) =>
	handleToggleAttributeValue(req, res, { isAdmin: true });

export const deleteAttributeValueAdmin = (req, res) =>
	handleDeleteAttributeValue(req, res, { isAdmin: true });

// --- Controller cho shop ---
export const createAttributeValueShop = (req, res) =>
	handleCreateAttributeValue(req, res, false);

export const updateAttributeValueShop = (req, res) =>
	handleUpdateAttributeValue(req, res, { isAdmin: false });

export const toggleAttributeValueShop = (req, res) =>
	handleToggleAttributeValue(req, res, { isAdmin: false });

export const deleteAttributeValueShop = (req, res) =>
	handleDeleteAttributeValue(req, res, { isAdmin: false });
