...
adminRouter.delete("/:id", validateParamId, AttributeController.deleteAttributeByAdmin);
adminRouter.patch("/toggle/:id", validateParamId, AttributeController.toggleAttributeByAdmin);
...
shopRouter.get("/available", AttributeController.getShopAvailableAttributesController);
...
shopRouter.delete("/:id", validateParamId, AttributeController.deleteAttributeByShop);
shopRouter.patch("/toggle/:id", validateParamId, AttributeController.toggleAttributeByShop);
shopRouter.get("/available/:id", AttributeController.getShopAvailableAttributeByIdController);
