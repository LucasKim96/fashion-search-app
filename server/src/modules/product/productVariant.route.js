...
shopRouter.post("/generate", ProductVariantController.generateVariantCombinations);
// Sinh tổ hợp biến thể mới (shop)
shopRouter.post("/generate-new", ProductVariantController.generateNewVariantCombinations);
