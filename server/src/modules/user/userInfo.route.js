...
import {
	uploadUserAvatar,
	uploadDefautlAvatar,
} from "../../middlewares/upload.middleware.js"; // import đúng
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	UserInfoController.searchUsers
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	UserInfoController.statsByGender
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	UserInfoController.statsByAgeRange
);
...
router.put(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	uploadDefautlAvatar.single("avatar"),
	UserInfoController.updateDefaultAvatar
);
...
router.put(
	...
	authMiddleware,
	isSelf,
	UserInfoController.updateBasicUserInfo
);
