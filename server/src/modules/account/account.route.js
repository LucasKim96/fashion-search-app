...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	AccountController.getAccountsByRole
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	AccountController.getBannedAccounts
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	AccountController.getUnbannedAccounts
);
...
router.patch(
	...
	authMiddleware,
	isSuperAdmin,
	AccountController.toggleBanAccount
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	AccountController.countByStatus
);
...
router.get(
	...
	authMiddleware,
	isAdminOrSuperAdmin,
	AccountController.countBannedAccounts
);
...
router.put(
	...
	AccountController.updateBasicInfo
);
